...
setwd("C:/Users/joelle.lousberg/OneDrive - Cawthron/Documents/Chapter_2/R_step2/BF1BR2_CO1")
...
blast.tax <- fread("BF1BR2_CO1.nochim_ASVs_blast_BOLD-ex.txt", header = FALSE)
head(blast.tax)
...
ASVCO1 <- fread("BF1BR2_CO1.nochim_ASVs_counts.tsv", header = T)
head(ASVCO1)
...
#head(ps_tax)
####
sample.data <-fread("C:/Users/joelle.lousberg/OneDrive - Cawthron/Documents/Chapter_2/R_step2/BF1BR2_CO1/CAW-25-36_sample_data.csv")
names(sample.data)
...
phyloseq_BF1BR2 <- phyloseq(ps_otu_table, ps_map, ps_tax)
phyloseq_BF1BR2
...
phyloseq_BF1BR2_clean <- phyloseq2
saveRDS(phyloseq_BF1BR2_clean, file = "phyloseq_BF1BR2_clean.rds")



##Load from here!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
phyloseq2 <- readRDS("phyloseq_BF1BR2_clean.rds")
ntaxa(phyloseq2)
...
ggplot(relabund_long_meta, aes(x = Lake, y = RelAbundance*100, fill = Group)) +
  ...
  xlab("Lake") +
  ggtitle("Rarefied & grouped taxa BF1/BR2") +
  theme_minimal() +
  theme(
...
Speciesfig_relzoopl_BF1BR2 <- plot_bar(
  ps_subset_rel,
  x = "Sample_Name",
  fill = "Species"
) +
  ...
  labs(
    title = "Relative Abundance of Species in Branchiopoda, Hexanauplia, and Eurotatoria BF1BR2",
    y = "Relative Abundance [%]",
    x = "Sample"
  )

print(Speciesfig_relzoopl_BF1BR2)



#Save the cleaned phyloseq object for statistical analyses and comparisons
phyloseqBF1BR2 <- phyloseq2
saveRDS(phyloseqBF1BR2, file = "phyloseqBF1BR2.rds")
