...
# Target taxa options
target_taxa = "18S"; forward_primer=c("ATYAGGGTTCGATTCCGGAGAGG"); reverse_primer=c("CTGGAATTACCGCGGSTGCTG");QF_args = list(truncLen = c(110,110), maxEE=c(4,6), truncQ=2, maxN=0, rm.phix=TRUE, compress=TRUE, verbose=TRUE, multithread=TRUE) # 18S Zhan
