...
# Target taxa options
target_taxa = "18S"; forward_primer=c("GCTTGTCTCAAAGATTAAGCC"); reverse_primer=c("GCCTGCTGCCTTCCTTGGA");QF_args = list(truncLen = c(220,220), maxEE=c(4,6), truncQ=2, maxN=0, rm.phix=TRUE, compress=TRUE, verbose=TRUE, multithread=TRUE) # 18S Zhan
